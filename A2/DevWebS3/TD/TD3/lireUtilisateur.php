...
<head>
    ...
    <title> HAYE Marc - TD3 - Query Utilisateurs </title>
</head>

<body>

<h1>TD3 - Requêtes Table Utilisateur </h1>

<?php
require_once 'Utilisateur.php';

echo "<h1>SELECT * FROM utilisateur;</h1>";

echo "<br>------------------------------------------------- <br>";

echo "<ul>";

foreach (Utilisateur::getUtilisateurs() as $utilisateurCourant)
{
    echo "<li>";
